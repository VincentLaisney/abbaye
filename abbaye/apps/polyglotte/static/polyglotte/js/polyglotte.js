$(document).ready(function () {
    ...
    $('#select_books').change(function () {
        window.location = '/abbaye/polyglotte/' + $('#select_books option:selected').val() + '/1';
    });

    $('#select_chapters').change(function () {
        window.location = '/abbaye/polyglotte/' + $('#select_books option:selected').val() + '/' + $('#select_chapters option:selected').val();
    });
    ...
    $('#previous_book').click(function () {
        ...
        window.location = '/abbaye/polyglotte/' + previous_book + '/1';
    });
    ...
    $('#next_book').click(function () {
        ...
        window.location = '/abbaye/polyglotte/' + next_book + '/1';
    });

    $('#previous_chapter').click(function () {
        var current_book = params_url[3];
        var current_chapter = params_url[4];
        if (current_chapter != 1) {
            window.location = '/abbaye/polyglotte/' + current_book + '/' + (parseInt(current_chapter) - 1);
        }
    })
